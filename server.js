document.addEventListener('DOMContentLoaded', () => {
    ...
    orderForm.addEventListener('submit', function(event) {
        ...
        const webAppURL = 'https://script.google.com/macros/s/AKfycbxvnA-DLbRiHUlxoOxZfAfj1Pote2_JYuZztSPc4AHA/dev'; // Replace with your Google Apps Script Web App URL
